...
void FireSwampSpace::spaceOutput()
{
    ...
    if (frodo->hasItems("BorgChunk") == false)
    {
        ...
        space[9][16] = NULL;
        cout << "\n\tLooks like you found a Borg piece...curious." << endl;
        ch = 0;
    }
    space[10][16] = frodo;
    printSpace();
    ...
    cout << "\n\tThe Kangaroorous lord was testing your bravery and you have proven yourself." << endl;
    cout << "\n\tHe has left you a gift." << endl;
