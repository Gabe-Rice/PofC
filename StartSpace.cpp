...
char ch = 0; //used to regulate when to press enter to continue, with getchar
...
void StartSpace::spaceOutput()
{
    ...
    if (frodo->hasItems("BorgChunk") == true && frodo->hasItems("SharpStick") == false)
    {
    ...
    cout << "\tIt is imperative that you continue on to find all the items." << endl;
    ...
    else if (gateChoice == 3 && frodo->hasItems("Gyro") == true)
    {
